...
Here we used topGO to calculate GO enrichment of DEGs vs all genes. Any term having P-value less than 0.05 is shown. We didn't calculate adjusted P-values because they did not give significant enrichment. Please interpret the output with caution. 
