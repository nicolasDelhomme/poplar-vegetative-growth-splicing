...
singularity exec $1 $2 -db $4 -query $3 -out $5/$fnam -word_size $WORD_SIZE -evalue $EVALUE $OPTIONS -num_threads $PROC -outfmt '6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen'
